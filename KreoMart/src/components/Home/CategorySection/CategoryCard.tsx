...
import { CategResult } from "../../../../typings";
...
const CategoryCard: React.FC<CategoryCardProps> = ({ data }) => {
  console.log(data, " Category data is being displayed!!");
  return (
    <Link
      href={{
        pathname: `${route.Products}/${decodeURIComponent(
          data.navigation_header[0]?.name
    ...
    >
      <div className=" bg-background p-10 relative  flex flex-col flex-1 items-center justify-center gap-8 text-center text-lg text-primary font-semibold shadow-gray-700 hover:shadow-lg transition duration-300">
        <div
          key={data.id}
          className=" h-[235px]  aspect-round flex  items-center justify-center  box-border gap-[32px]"
        >
          <Image
